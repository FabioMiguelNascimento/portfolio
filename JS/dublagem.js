var translations = {
    'en': {
        ...
        'BoxProjectName': 'Online Store (Under construction)',
        'BoxProjectText': 'This project is a replica of an e-commerce store for selling various products. It relies on JavaScript to perform the functions of scrolling, product categories (in production), shopping cart (in production), product filtering (in production )',
    ...
    'pt': {
        ...
        'BoxProjectName': 'Loja Online (Em construção)',
        'BoxProjectText': 'Este projeto é uma réplica de uma loja de comércio eletrônico para venda de diversos produtos.Ele conta com JavaScript para realizar as funções de rolagem, categorias de produtos(em produção), carrinho de compras(em produção), filtragem de produtos(em produção)',
